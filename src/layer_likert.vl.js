	...
	return {
		...
		encoding: {
			y: {
				...
				type: 'nominal',
				sort: null,
				axis: { domain: false, offset: 50, labelFontWeight: 'bold', ticks: false, grid: true, title: null }
			},
			x: {
				type: 'quantitative',
				scale: { domain: [0, 6] },
		...
		layer: [
			{
				...
				encoding: {
					x: { field: 'value' },
					size: { aggregate: 'count', type: 'quantitative', title: 'Number of Ratings', legend: { offset: 75 } },
					color: { value: '#6EB4FD' }
				}
			},
			{
