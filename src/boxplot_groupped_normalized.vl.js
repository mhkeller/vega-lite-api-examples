...
export default function chart () {
	...
	const outLayer1C2C1 = vl
		...
		.encode(
			vl.x().fieldN('Cylinders'),
			vl.xOffset().fieldN('Origin'),
			vl.y().fieldQ('lower_whisker_Acceleration').title('Acceleration'),
			vl.y2().field('lower_box_Acceleration'),
			vl.tooltip([
				vl.tooltip().fieldQ('upper_whisker_Acceleration')
					.title('Upper Whisker of Acceleration'),
				vl.tooltip().fieldQ('lower_whisker_Acceleration')
	...
	const outLayer1C2C2 = vl
		...
		.encode(
			vl.x().fieldN('Cylinders'),
			vl.xOffset().fieldN('Origin'),
			vl.y().fieldQ('upper_box_Acceleration').title('Acceleration'),
	...
	const outerLayer1C2 = vl
		...
		.transform(
			...
			vl.aggregate(
				{ op: 'min', field: 'Acceleration', as: 'lower_whisker_Acceleration' },
				{ op: 'max', field: 'Acceleration', as: 'upper_whisker_Acceleration' },
				{ op: 'min', field: 'lower_box_Acceleration', as: 'lower_box_Acceleration' },
				{ op: 'max', field: 'upper_box_Acceleration', as: 'upper_box_Acceleration' }
	...
	const outerLayer1 = vl
		...
		.transform(
			vl.joinaggregate(
				{ op: 'q1', field: 'Acceleration', as: 'lower_box_Acceleration' },
				{ op: 'q3', field: 'Acceleration', as: 'upper_box_Acceleration' }
			).groupby(['Cylinders', 'Origin', 'Origin'])
		);
	...
	const outerLayer2C1 = vl
		...
		.encode(
			vl.x().fieldN('Cylinders'),
			vl.xOffset().fieldN('Origin'),
			vl.y().fieldQ('lower_box_Acceleration').title('Acceleration'),
			vl.y2().field('upper_box_Acceleration'),
			vl.color().fieldN('Origin'),
			vl.tooltip([
				vl.tooltip().fieldQ('max_Acceleration')
					.title('Max of Acceleration'),
				vl.tooltip().fieldQ('upper_box_Acceleration')
					.title('Q3 of Acceleration'),
				vl.tooltip().fieldQ('mid_box_Acceleration')
					.title('Median of Acceleration'),
				vl.tooltip().fieldQ('lower_box_Acceleration')
					.title('Q1 of Acceleration'),
				vl.tooltip().fieldQ('min_Acceleration')
	...
	const outerLayer2C2 = vl
		...
		.encode(
			vl.x().fieldN('Cylinders'),
			vl.xOffset().fieldN('Origin'),
			vl.y().fieldQ('mid_box_Acceleration').title('Acceleration'),
			vl.tooltip([
				vl.tooltip().fieldQ('max_Acceleration')
					.title('Max of Acceleration'),
				vl.tooltip().fieldQ('upper_box_Acceleration')
	...
	const outerLayer2 = vl
		...
		.transform(
			vl.aggregate(
				{ op: 'q1', field: 'Acceleration', as: 'lower_box_Acceleration' },
				{ op: 'q3', field: 'Acceleration', as: 'upper_box_Acceleration' },
				{ op: 'median', field: 'Acceleration', as: 'mid_box_Acceleration' },
