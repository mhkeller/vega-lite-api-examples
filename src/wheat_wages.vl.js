...
export default function chart() {
	return {
		...
		encoding: {
			...
			x: { type: 'quantitative', axis: { tickCount: 5, format: 'd' } }
		},
		layer: [
			{
				mark: { type: 'bar', fill: '#aaa', stroke: '#999' },
			...
			{
				data: { values: [{ year: '1600' }, { year: '1650' }, { year: '1700' }, { year: '1750' }, { year: '1800' }] },
				mark: { type: 'rule', stroke: '#000', strokeWidth: 0.6, opacity: 0.5 },
			...
			},
			{
				...
				encoding: {
					...
					y: { field: 'y' },
					y2: { field: 'offset' },
					fill: { field: 'commonwealth', scale: { range: ['black', 'white'] }, legend: null }
				}
			},
			{
				data: { url: 'data/monarchs.json' },
				...
				mark: { type: 'text', yOffset: 16, fontSize: 9, baseline: 'bottom', fontStyle: 'italic' },
				encoding: { x: { field: 'x' }, y: { field: 'off2' }, text: { field: 'name' } }
			}
		],
		config: {
